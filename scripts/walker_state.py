...
class WalkerState(object):
    ...
    def __init__(self, desired_x = 6,done_reward = -1000.0):
        ...
        rospy.Subscriber("/front_left_contact_sensor", ContactsState, self.front_left_contact_sensor)
        rospy.Subscriber("/front_right_contact_sensor", ContactsState, self.front_right_contact_sensor)
        rospy.Subscriber("/rear_left_contact_sensor", ContactsState, self.rear_left_contact_sensor)
        rospy.Subscriber("/rear_right_contact_sensor", ContactsState, self.rear_right_contact_sensor)
    ...
    def check_all_systems_ready(self):
        ...
        while front_left_contacts_data is None and not rospy.is_shutdown():
            try:
                front_left_contacts_data = rospy.wait_for_message("/front_left_contact_sensor", ContactsState, timeout=0.1)
        ...
        while front_right_contacts_data is None and not rospy.is_shutdown():
            try:
                front_right_contacts_data = rospy.wait_for_message("/front_right_contact_sensor", ContactsState, timeout=0.1)
        ...
        while rear_left_contacts_data is None and not rospy.is_shutdown():
            try:
                rear_left_contacts_data = rospy.wait_for_message("/rear_left_contact_sensor", ContactsState, timeout=0.1)
        ...
        while rear_right_contacts_data is None and not rospy.is_shutdown():
            try:
                rear_right_contacts_data = rospy.wait_for_message("/rear_right_contact_sensor", ContactsState, timeout=0.1)
